...
export type MenuPropsLinks = {
  //criando as propriedades dos links, igual do mock
  id: string;
  link: string;
  newTab?: boolean;
  text: string;
    ...
    <>
      ...
      <Styled.Wrapper menuVisible={menuVisible} aria-hidden={!menuVisible}>
        <Styled.Nav>
          ...
          {/*criando um link para cada item do array links que vem como propriedade, também poderia colocar o nome de "item" em vez de "link"*/}
          {links.map((link) => (
